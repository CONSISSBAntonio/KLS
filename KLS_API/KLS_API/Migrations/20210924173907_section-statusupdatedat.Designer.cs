...
namespace KLS_API.Migrations
{
    ...
    [Migration("20210924173907_section-statusupdatedat")]
    partial class sectionstatusupdatedat
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KLS_API.Models.Carriers.ruta_has_inventario", b =>
                {
                    ...
                    b.Property<decimal>("Circuito")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CostoOne")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CostoTwo")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("KLS_API.Models.Travel.ServiceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KLS_API.Models.Travel.TravelService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KLS_API.Models.Demands.Demand", b =>
                {
                    ...
                    b.HasOne("KLS_API.Models.Travel.TravelService", "TravelService")
                        .WithMany()
            ...
            modelBuilder.Entity("KLS_API.Models.Travel.Evidence", b =>
                {
                    b.HasOne("KLS_API.Models.Travel.SectionComment", null)
                        .WithMany("Evidences")
            ...
            modelBuilder.Entity("KLS_API.Models.Travel.Service", b =>
                {
                    ...
                    b.HasOne("KLS_API.Models.Travel.ServiceType", "ServiceType")
                        .WithMany()
