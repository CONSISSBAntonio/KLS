#pragma checksum "C:\Users\Consiss\Source\Repos\KLS\KLS_WEB\KLS_WEB\Views\Route\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1f6b4d7cf2032ad8cac37c4b68da5736324c3bc0"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1f6b4d7cf2032ad8cac37c4b68da5736324c3bc0", @"/Views/Route/Index.cshtml")]
...
<div class=""p-4 body"">
    ...
    <script>
        ...
        function loadState() {
  ");
                WriteLiteral(@"          $.get(""/Catalogs/Geography/State/getState"", function (res) {
                catEstado = res;
            }).fail(function (error) {
                dToast(""error"", ""Error al obtener paises"", ""Atencion!"");
            });
        ...
        function loadTable() {
            ...
            $.get(""Route/getRoute"", function (res) {
                ...
                $.each(res, (item, key) => {
                    ...
                    const tipoviajeabreviado = nCon(key.tipo");
                WriteLiteral(@"deviaje) == 'One Way' ? '1W' : nCon(key.tipodeviaje) == 'Two Way' ? '2W' : 'C';
                    ...
                    $(""#table-info"").append(`
                            ...
                            <td class=""text-center"">${tipov");
                WriteLiteral(@"iajeabreviado}</td>
                ...
                dToast(""error"", ""Error al tratar de o");
                WriteLiteral("btener los registros, intenta cerrar sesión y volver a iniciar.\", \"Error\");\r\n            });\r\n        }\r\n    </script>\r\n");
            }
            );
            WriteLiteral(" ");
        }
