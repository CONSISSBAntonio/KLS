...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d5595cd3e4b79cfba216de4bfa6a9d7c46e3cc76", @"/Views/Catalogs/City/Index.cshtml")]
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(""#frmRegister"").submit(function (event) {
                ...
                if (parseInt($(""#idEditar"").val()) != 0) {
                    ...
                    $.post(""City/");
                WriteLiteral(@"setCity"", jsonData, function (res) {
                        loadTable();
        ...
        function showModal(titulo = ""Title"", accion, idEditar = 0) {
            ...
            if (accion == ""Editar"") {
                try {
        ");
                WriteLiteral(@"            let indice = dataCity.findIndex(service => service.id === idEditar);
                ...
                $.each(res, function (item, key) {
                    ...
                    $(""#table-info"").append(`
                             <tr>
                                ...
                                <td>
                                    <a href=""#"">
                                        <span class=""material-icons"" onclick=""showModal('EDITAR','Editar',${nCo");
                WriteLiteral(@"n(key.id)});"">
                                            mode_edit
                                        </span>
                                    </a>
                                </td>
