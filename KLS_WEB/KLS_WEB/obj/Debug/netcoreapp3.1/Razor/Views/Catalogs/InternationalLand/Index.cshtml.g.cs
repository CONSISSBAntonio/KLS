...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8094f6d128f6dae3c5264d2bae870ac4f62c995a", @"/Views/Catalogs/InternationalLand/Index.cshtml")]
        ...
        function showModal(titulo = ""Title"", accion, idEditar = 0) {
            ...
            if (accion == ""Editar"") {
                try {
                    ...
                    $(""#nombr");
                WriteLiteral(@"e"").val(dataInternational[indice].nombre);
