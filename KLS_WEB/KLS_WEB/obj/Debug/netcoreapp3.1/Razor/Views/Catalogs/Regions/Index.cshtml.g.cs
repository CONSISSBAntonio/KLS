...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"fe99dea5914b48c25b6088f07ab6e117c3d91eb2", @"/Views/Catalogs/Regions/Index.cshtml")]
...
<div class=""modal fade"" id=""modalDiv"" tabindex=""-1"" role=""dialog"" data-backdrop=""static"" data-keyboard=""false"" aria-labelledby=""exampleModalLabel"" aria-hidden=""true"">
    ...
    <script>
        ...
        function delBtn(id) {
            ...
            if (indice < 0) {
                dToast(""error"", ""No se encontro estado a eliminar!""");
        ...
        function showModal(titulo = ""Title"", accion, idEditar = 0) {
            ...
            ");
                WriteLiteral(@"        $('#estatus option[value=""' + dataRegions[indice].estatus + '""]').attr(""selected"", true);
                    $(""#modalDiv"").modal(""show"");
                } catch (error) {
...
");
     ...
     ");
                WriteLiteral(@"                   let indice_e = catEstado.findIndex(service => service.id === key_r.id_estado);
                ...
                dToas");
                WriteLiteral("t(\"error\", \"Error al tratar de obtener los registros, intenta cerrar sesión y volver a iniciar.\", \"Error\");\r\n            });\r\n        }\r\n    </script>\r\n");
            }
            );
            WriteLiteral(" ");
        }
